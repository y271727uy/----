...
Copyright Statement: The original content of this material belongs to the relevant educational institution and instructors. y271727uy acts solely as the licensor and distributor within permitted scope, and does not claim ownership of the copyright.

## Summary

This material is intended solely for non-commercial personal and organizational learning purposes. Any form of public distribution, commercial use, or use in AI model training is strictly prohibited. Downloading, saving, or using this material implies full acceptance of all terms herein. Please read carefully.

## Main Terms

1. **Nature and Scope of Use**  
   This material consists of original educational notes. Any individual or organization may use it for self-study, internal review, and research communication on a non-commercial basis. Use in teaching, public release, sales, distribution, or other profit-making activities is prohibited.
2. **Copyright Ownership**  
   The original content and rights belong to the relevant educational institutions and instructors. y271727uy is only the licensor and distributor and does not claim ownership. All derivative works are subject to this agreement.
3. **Permitted Use**  
   - Individuals may download and store the material on personal computing devices (PCs, tablets, phones) for study purposes.  
   - Schools, study groups, and non-profit organizations may use the material internally for learning.  
   - Users may make personal notes, annotations, and citations, provided no prohibited uses occur.  
   - Use within "Trusted Private Platforms" (defined in the Additional Terms) for non-public communication and learning is permitted.  
   - **Learners are permitted to share the official download link of this material hosted on GitHub (or other official platforms) to indirectly distribute the material, provided that only the link is shared—not the material files or content directly.**
4. **Prohibited Actions**  
   - Any form of public distribution, reposting, forwarding, sharing, or unauthorized distribution of the material or parts thereof is prohibited.  
   - Charging fees, selling, or otherwise profiting from the material is prohibited.  
   - Publishing full or partial content of the material on social media, video platforms, forums, or public websites—including screenshots, excerpts, transcriptions, or text reorganizations—is prohibited.  
   - Using the material for teaching, lectures, commercial training, or any profit-driven knowledge transmission is prohibited.  
   - Actions infringing upon the reputation, privacy, or other legal rights of the original authors, educational institutions, instructors, or distributor (y271727uy) are prohibited.  
   - Use of the material in violation of laws and regulations applicable in Mainland China and related jurisdictions is prohibited.  
   - Use of the material for any AI training, model optimization, data analysis, or related technological development—including language models, image recognition, or generative models—is prohibited.  
   - Storing, copying, or distributing the material on non-computing devices or in physical form—including printing, photocopying, audio/video recording, USB drives, memory cards, or other media—is prohibited. Unauthorized such acts are infringements subject to enforcement by copyright holders.  
...
Downloading, viewing, storing, or using this material constitutes your full understanding and unconditional acceptance of all terms herein. If you do not agree to any clause, please immediately cease use and delete all material.
...
7. **禁止用于 AI 大模型训练**  
  严禁任何个人、企业、机构或组织将本仓库内资料用于人工智能大模型（LLM）或相关系统的训练、微调、增强、语料构建、输入分析或任何形式的机器学习处理。
该禁止适用于所有用途，包括但不限于商业用途、学术研究、实验测试等，亦适用于直接或间接上传、嵌入、转换、解析等行为。
...
允许个人用户将本资料存储于 GitHub 私有仓库，仅限用于个人学习目的，前提条件如下：
     ...
     - 禁止通过该私有仓库进行传播、分享、克隆、Fork 或导出操作；
     - 一旦发现私有仓库资料被间接公开或传播，视为违反本协议；
     - 出于学习协同等特殊用途，如确需多人访问，须提前通过 GitHub Issues 获得书面授权。
